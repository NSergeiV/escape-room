...
Доработать форму бронирования и отправки на сервер.
После успешной отправки перенаправление на страницу «Мои бронирования»

# Прошу строго не судить!!!

Я стараюсь выучиться и сменить профессию, которая была не связана с программированием (авиационный техник). Я мечта заниматься этим с детства.

# Ошибки, которые я не успел исправить:

Не разобрался, т.к. не успел доделать проект, почему на некоторых страницах при нажатии F5, ломается разметка страницы…
