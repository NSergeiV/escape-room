...
import { COORDINATES_ORGANIZATION, ZOOM_MAP_ORGANIZATION } from '../../const/const';

import Map from '../../components/map-organization/map-organization';
          ...
          <div className="contacts__map">
            <div className="map">
              <div className="map__container">
                <Map coordinates={COORDINATES_ORGANIZATION} zoomMap={ZOOM_MAP_ORGANIZATION} />
              </div>
            </div>
          </div>
        </div>
